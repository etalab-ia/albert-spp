...
#         "url": "http://albert.gpu.005.etalab.gouv.fr:8001/v1",
#         "token": albert_api_key,
#         "template": "spp_fewshots.jinja",
#     },
...
#     completion = client.chat.completions.create(model=model, messages=messages, **sampling_params)
